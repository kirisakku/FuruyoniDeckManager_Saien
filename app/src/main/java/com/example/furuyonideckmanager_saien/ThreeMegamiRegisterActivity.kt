...
import com.example.furuyonideckmanager_saien.databinding.ActivityThreeMegamiRegisterBinding
...
class ThreeMegamiRegisterActivity : AppCompatActivity(), GroupNameDialog.Listener {
    ...
    fun setClickListeners() {
        ...
        binding.korunuA1.setOnClickListener {onButtonTapped(binding.korunuA1, "korunu_a1")}
        binding.megumi.setOnClickListener {onButtonTapped(binding.megumi, "megumi")}
        binding.megumiA1.setOnClickListener {onButtonTapped(binding.megumiA1, "megumi_a1")}
    }
